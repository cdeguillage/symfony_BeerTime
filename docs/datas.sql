...
INSERT INTO `beertime`.`t_event` (`name`, `description`, `dateeventStart`, `dateeventEnd`, `price`, `idaddress`, `idusercreate`) VALUES ('Place of beer', 'Place of beer description', '2018-01-01', '2018-01-01', '27', '1', '1');
INSERT INTO `beertime`.`t_event` (`name`, `description`, `dateeventStart`, `dateeventEnd`, `price`, `idaddress`, `idusercreate`) VALUES ('The festbeer', 'The festbeer description', '2018-11-01', '2018-12-31', '0', '2', '2');
INSERT INTO `beertime`.`t_event` (`name`, `description`, `dateeventStart`, `dateeventEnd`, `price`, `idaddress`, `idusercreate`) VALUES ('Event of beer', 'Event of beer description', '2018-12-15', '2015-12-31', '237', '3', '2');

INSERT INTO `beertime`.`t_program` (`idevent`, `title`, `description`, `timeperiodStart`, `timeperiodEnd`, `price`) VALUES ('1', 'Place of beer H1', 'Place of beer - baptème', '17', '20', '10');
INSERT INTO `beertime`.`t_program` (`idevent`, `title`, `description`, `timeperiodStart`, `timeperiodEnd`, `price`) VALUES ('1', 'Place of beer H2', 'Place of beer - Yeeaaahhhh', '20', '8', '15');
INSERT INTO `beertime`.`t_program` (`idevent`, `title`, `description`, `timeperiodStart`, `timeperiodEnd`, `price`) VALUES ('2', 'The festbeer', 'The festbeer', '11', '23', '0');
INSERT INTO `beertime`.`t_program` (`idevent`, `title`, `description`, `timeperiodStart`, `timeperiodEnd`, `price`) VALUES ('3', 'Event of beer', 'Event of beer', '18', '8', '0');
